...
public class UseExplicitTypeInsteadOfVarWhenTypeIsObviousAnalyzerRCS1012 extends RoslynRecipe {
    ...
    public String getDisplayName() {
        return "Analysis: [deprecated] Use explicit type instead of 'var' (when the type is obvious)";
    }
    ...
    public Set<String> getTags() {
        return Stream.of("roslyn", "analyzer", "RCS1012", "roslynator", "csharp", "dotnet", "c#").collect(Collectors.toSet());
    }
    }
