...
@Getter
public class CSharpPreferDictionaryTryMethodsOverContainsKeyGuardFixerCA1864 extends RoslynRecipe {
    ...
    final Set<String> tags = Stream.of("roslyn", "codefix", "CA1864", "microsoft", "csharp", "dotnet", "c#").collect(Collectors.toSet());
