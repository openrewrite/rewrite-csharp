...
public class RenameMemberFixWPF0100 extends RoslynRecipe {
    @Getter
    ...
    @Getter
    final Set<String> tags = Stream.of("roslyn", "codefix", "WPF0100", "wpfanalyzers", "csharp", "dotnet", "c#").collect(Collectors.toSet());
