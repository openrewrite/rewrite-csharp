...
{
    public static HashBuilder Builder<T>(T initial) where T : class
    {
        var builder = new HashBuilder();
        builder.Combine(initial);
        return builder;
    }
    ...
    public struct HashBuilder
    {
        ...
        public HashBuilder Combine<T>(T newPart) where T : class?
        {
            HashCode = Hash.Combine(newPart, HashCode);
            return this;
        }
        public HashBuilder CombineValue<T>(T newPart) where T : struct
        {
            HashCode = Hash.Combine(newPart.GetHashCode(), HashCode);
            return this;
        }
    }
    /// <summary>
