...
public class AttachedPropertyBrowsableForTypeArgumentFixWPF0034 extends RoslynRecipe {
    @Getter
    ...
    @Getter
    final Set<String> tags = Stream.of("roslyn", "codefix", "WPF0034", "wpfanalyzers", "csharp", "dotnet", "c#").collect(Collectors.toSet());
