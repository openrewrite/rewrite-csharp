...
public class UriParametersShouldNotBeStringsAnalyzerCA1054 extends RoslynRecipe {
    @Getter
    ...
    @Getter
    final String displayName = "Analysis: URI-like parameters should not be strings";
    ...
    @Getter
    final Set<String> tags = Stream.of("roslyn", "analyzer", "CA1054", "microsoft", "csharp", "dotnet", "c#").collect(Collectors.toSet());
