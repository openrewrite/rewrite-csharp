...
public class ImplementExceptionConstructorsAnalyzerRCS1194 extends RoslynRecipe {
    ...
    @Getter
    final String displayName = "Analysis: Implement exception constructors";

    @Getter
    final String description = "This is a reporting only recipe. ";

    @Getter
    final Set<String> tags = Stream.of("roslyn", "analyzer", "RCS1194", "roslynator", "csharp", "dotnet", "c#").collect(Collectors.toSet());
