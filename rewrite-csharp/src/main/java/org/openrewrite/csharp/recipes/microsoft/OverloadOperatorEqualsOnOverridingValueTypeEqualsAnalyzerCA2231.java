...
public class OverloadOperatorEqualsOnOverridingValueTypeEqualsAnalyzerCA2231 extends RoslynRecipe {
    ...
    public String getDisplayName() {
        return "Analysis: Overload operator equals on overriding value type Equals";
    }
    ...
    public Set<String> getTags() {
        return Stream.of("roslyn", "analyzer", "CA2231", "microsoft", "csharp", "dotnet", "c#").collect(Collectors.toSet());
    }
    }
