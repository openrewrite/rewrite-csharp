...
public sealed class ResolvePackageAssets : TaskBase
{
    ...
    /// </summary>
    private bool DisablePackageAssetsCache { get; set; } = true;
    ...
    /// </summary>
    [Required]
    public string DefaultImplicitPackages { get; set; } = "Microsoft.NETCore.App;NETStandard.Library";
    ...
    private sealed class CacheReader : IDisposable
    {
        ...
        private static BinaryReader CreateReaderFromDisk(ResolvePackageAssets task, byte[] settingsHash)
        {
            ...
            bool IsCacheFileUpToDate() => false;
        }
