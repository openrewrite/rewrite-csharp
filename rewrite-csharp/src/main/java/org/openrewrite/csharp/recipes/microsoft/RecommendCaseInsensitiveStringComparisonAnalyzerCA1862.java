...
public class RecommendCaseInsensitiveStringComparisonAnalyzerCA1862 extends RoslynRecipe {
    ...
    public String getDisplayName() {
        return "Analysis: Use the 'StringComparison' method overloads to perform case-insensitive string comparisons";
    }
    ...
    public Set<String> getTags() {
        return Stream.of("roslyn", "analyzer", "CA1862", "microsoft", "csharp", "dotnet", "c#").collect(Collectors.toSet());
    }
    }
