...
public class AddOverloadWithSpanOrMemoryAnalyzerMA0109 extends RoslynRecipe {
    ...
    public String getDisplayName() {
        return "Analysis: Consider adding an overload with a Span<T> or Memory<T>";
    }
    ...
    public Set<String> getTags() {
        return Stream.of("roslyn", "analyzer", "MA0109", "meziantou", "csharp", "dotnet", "c#").collect(Collectors.toSet());
    }
    }
