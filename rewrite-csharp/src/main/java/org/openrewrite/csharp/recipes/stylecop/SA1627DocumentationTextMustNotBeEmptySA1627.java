...
public class SA1627DocumentationTextMustNotBeEmptySA1627 extends RoslynRecipe {
    ...
    @Getter
    final String displayName = "Analysis: Documentation text should not be empty";
    ...
    @Getter
    final Set<String> tags = Stream.of("roslyn", "analyzer", "SA1627", "stylecop", "csharp", "dotnet", "c#").collect(Collectors.toSet());
