...
public class SA1112ClosingParenthesisMustBeOnLineOfOpeningParenthesisSA1112 extends RoslynRecipe {
    ...
    final String displayName = "Closing parenthesis should be on line of opening parenthesis (search)";
    ...
    final Set<String> tags = Stream.of("roslyn", "analyzer", "SA1112", "stylecop", "csharp", "dotnet", "c#").collect(toSet());
