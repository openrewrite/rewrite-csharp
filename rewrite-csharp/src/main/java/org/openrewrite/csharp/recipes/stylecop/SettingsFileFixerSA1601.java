...
public class SettingsFileFixerSA1601 extends RoslynRecipe {
    @Getter
    ...
    @Getter
    final Set<String> tags = Stream.of("roslyn", "codefix", "SA1601", "stylecop", "csharp", "dotnet", "c#").collect(Collectors.toSet());
