...
@Getter
public class CSharpDoNotUseCountWhenAnyCanBeUsedFixerCA1827 extends RoslynRecipe {
    ...
    final Set<String> tags = Stream.of("roslyn", "codefix", "CA1827", "microsoft", "csharp", "dotnet", "c#").collect(Collectors.toSet());
