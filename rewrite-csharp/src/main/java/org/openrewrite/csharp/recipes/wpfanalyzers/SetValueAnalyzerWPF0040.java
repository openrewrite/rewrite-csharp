...
public class SetValueAnalyzerWPF0040 extends RoslynRecipe {
    ...
    final String displayName = "A readonly DependencyProperty must be set with DependencyPropertyKey (search)";
    ...
    final Set<String> tags = Stream.of("roslyn", "analyzer", "WPF0040", "wpfanalyzers", "csharp", "dotnet", "c#").collect(toSet());
