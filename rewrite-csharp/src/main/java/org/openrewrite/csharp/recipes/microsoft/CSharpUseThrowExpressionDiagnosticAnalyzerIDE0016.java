...
public class CSharpUseThrowExpressionDiagnosticAnalyzerIDE0016 extends RoslynRecipe {
    ...
    @Getter
    final String displayName = "Analysis: Use 'throw' expression";

    @Getter
    final String description = "This is a reporting only recipe. ";

    @Getter
    final Set<String> tags = Stream.of("roslyn", "analyzer", "IDE0016", "microsoft", "csharp", "dotnet", "c#").collect(Collectors.toSet());
