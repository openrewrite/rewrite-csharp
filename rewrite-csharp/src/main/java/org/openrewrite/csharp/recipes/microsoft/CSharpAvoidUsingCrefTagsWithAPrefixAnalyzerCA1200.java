...
public class CSharpAvoidUsingCrefTagsWithAPrefixAnalyzerCA1200 extends RoslynRecipe {
    ...
    final String displayName = "Avoid using cref tags with a prefix (search)";
    ...
    final Set<String> tags = Stream.of("roslyn", "analyzer", "CA1200", "microsoft", "csharp", "dotnet", "c#").collect(toSet());
