...
public class ConstructorArgumentParametersShouldExistInConstructorsAnalyzerMA0083 extends RoslynRecipe {
    ...
    public String getDisplayName() {
        return "Analysis: ConstructorArgument parameters should exist in constructors";
    }
    ...
    public Set<String> getTags() {
        return Stream.of("roslyn", "analyzer", "MA0083", "meziantou", "csharp", "dotnet", "c#").collect(Collectors.toSet());
    }
    }
