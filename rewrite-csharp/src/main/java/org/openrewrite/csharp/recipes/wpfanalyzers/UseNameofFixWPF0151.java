...
@Getter
public class UseNameofFixWPF0151 extends RoslynRecipe {
    ...
    final Set<String> tags = Stream.of("roslyn", "codefix", "WPF0151", "wpfanalyzers", "csharp", "dotnet", "c#").collect(Collectors.toSet());
