...
@Getter
public class UseEnvironmentMembersFixerCA1840 extends RoslynRecipe {
    ...
    final Set<String> tags = Stream.of("roslyn", "codefix", "CA1840", "microsoft", "csharp", "dotnet", "c#").collect(Collectors.toSet());
