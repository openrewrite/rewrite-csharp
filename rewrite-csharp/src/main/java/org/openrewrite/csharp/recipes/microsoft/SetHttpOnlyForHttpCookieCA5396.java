...
public class SetHttpOnlyForHttpCookieCA5396 extends RoslynRecipe {
    ...
    final String displayName = "Set HttpOnly to true for HttpCookie (search)";
    ...
    final Set<String> tags = Stream.of("roslyn", "analyzer", "CA5396", "microsoft", "csharp", "dotnet", "c#").collect(toSet());
