...
public class CSharpRemoveUnnecessaryAttributeSuppressionsDiagnosticAnalyzerIDE0077 extends RoslynRecipe {
    ...
    public String getDisplayName() {
        return "Analysis: Avoid legacy format target in 'SuppressMessageAttribute'";
    }
    ...
    public Set<String> getTags() {
        return Stream.of("roslyn", "analyzer", "IDE0077", "microsoft", "csharp", "dotnet", "c#").collect(Collectors.toSet());
    }
    }
