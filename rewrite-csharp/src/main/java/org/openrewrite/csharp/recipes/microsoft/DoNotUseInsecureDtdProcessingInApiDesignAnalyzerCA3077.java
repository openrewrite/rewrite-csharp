...
public class DoNotUseInsecureDtdProcessingInApiDesignAnalyzerCA3077 extends RoslynRecipe {
    ...
    final String displayName = "Insecure Processing in API Design, XmlDocument and XmlTextReader (search)";
    ...
    final Set<String> tags = Stream.of("roslyn", "analyzer", "CA3077", "microsoft", "csharp", "dotnet", "c#").collect(toSet());
