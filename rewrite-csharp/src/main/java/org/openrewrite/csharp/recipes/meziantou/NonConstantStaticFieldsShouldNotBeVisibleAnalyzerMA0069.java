...
public class NonConstantStaticFieldsShouldNotBeVisibleAnalyzerMA0069 extends RoslynRecipe {
    ...
    public String getDisplayName() {
        return "Analysis: Non-constant static fields should not be visible";
    }
    ...
    public Set<String> getTags() {
        return Stream.of("roslyn", "analyzer", "MA0069", "meziantou", "csharp", "dotnet", "c#").collect(Collectors.toSet());
    }
    }
