...
public class InvokeDelegateWithConditionalAccessAnalyzerIDE1005 extends RoslynRecipe {
    ...
    final String displayName = "Delegate invocation can be simplified. (search)";
    final String description = "This is a reporting only recipe. ";
    final Set<String> tags = Stream.of("roslyn", "analyzer", "IDE1005", "microsoft", "csharp", "dotnet", "c#").collect(toSet());
