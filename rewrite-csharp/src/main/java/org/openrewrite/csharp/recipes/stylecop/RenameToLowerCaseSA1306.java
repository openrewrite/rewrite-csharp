...
public class RenameToLowerCaseSA1306 extends RoslynRecipe {
    ...
    @Getter
    final Set<String> tags = Stream.of("roslyn", "SA1306", "stylecop", "csharp", "dotnet", "c#").collect(Collectors.toSet());
    }
