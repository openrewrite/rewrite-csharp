...
public class UseEnvironmentMembersCA1840 extends RoslynRecipe {
    ...
    final String displayName = "Use 'Environment.CurrentManagedThreadId' (search)";
    ...
    final Set<String> tags = Stream.of("roslyn", "analyzer", "CA1840", "microsoft", "csharp", "dotnet", "c#").collect(toSet());
