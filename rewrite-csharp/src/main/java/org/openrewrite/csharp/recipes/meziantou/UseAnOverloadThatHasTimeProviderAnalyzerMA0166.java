...
public class UseAnOverloadThatHasTimeProviderAnalyzerMA0166 extends RoslynRecipe {
    ...
    public String getDisplayName() {
        return "Analysis: Forward the TimeProvider to methods that take one";
    }
    ...
    public Set<String> getTags() {
        return Stream.of("roslyn", "analyzer", "MA0166", "meziantou", "csharp", "dotnet", "c#").collect(Collectors.toSet());
    }
    }
