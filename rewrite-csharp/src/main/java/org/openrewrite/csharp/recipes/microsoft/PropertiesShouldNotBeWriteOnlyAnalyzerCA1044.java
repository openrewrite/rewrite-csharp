...
public class PropertiesShouldNotBeWriteOnlyAnalyzerCA1044 extends RoslynRecipe {
    ...
    final String displayName = "Properties should not be write only (search)";
    ...
    final Set<String> tags = Stream.of("roslyn", "analyzer", "CA1044", "microsoft", "csharp", "dotnet", "c#").collect(toSet());
