...
@Getter
public class TokenSpacingFixerSA1023 extends RoslynRecipe {
    ...
    final Set<String> tags = Stream.of("roslyn", "codefix", "SA1023", "stylecop", "csharp", "dotnet", "c#").collect(Collectors.toSet());
