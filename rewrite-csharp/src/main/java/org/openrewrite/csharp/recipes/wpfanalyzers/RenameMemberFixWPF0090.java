...
public class RenameMemberFixWPF0090 extends RoslynRecipe {
    @Getter
    ...
    @Getter
    final Set<String> tags = Stream.of("roslyn", "codefix", "WPF0090", "wpfanalyzers", "csharp", "dotnet", "c#").collect(Collectors.toSet());
