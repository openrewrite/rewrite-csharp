...
public class NonFlagsEnumsShouldNotBeMarkedWithFlagsAttributeAnalyzerMA0062 extends RoslynRecipe {
    ...
    public String getDisplayName() {
        return "Analysis: Non-flags enums should not be marked with \"FlagsAttribute\"";
    }
    ...
    public Set<String> getTags() {
        return Stream.of("roslyn", "analyzer", "MA0062", "meziantou", "csharp", "dotnet", "c#").collect(Collectors.toSet());
    }
    }
