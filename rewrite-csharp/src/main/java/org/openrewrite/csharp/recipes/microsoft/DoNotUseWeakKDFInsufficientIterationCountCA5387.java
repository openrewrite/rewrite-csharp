...
public class DoNotUseWeakKDFInsufficientIterationCountCA5387 extends RoslynRecipe {
    ...
    final String displayName = "Do Not Use Weak Key Derivation Function With Insufficient Iteration Count (search)";
    ...
    final Set<String> tags = Stream.of("roslyn", "analyzer", "CA5387", "microsoft", "csharp", "dotnet", "c#").collect(toSet());
