...
@Getter
public class SA1139FixerSA1139 extends RoslynRecipe {
    ...
    final Set<String> tags = Stream.of("roslyn", "codefix", "SA1139", "stylecop", "csharp", "dotnet", "c#").collect(Collectors.toSet());
