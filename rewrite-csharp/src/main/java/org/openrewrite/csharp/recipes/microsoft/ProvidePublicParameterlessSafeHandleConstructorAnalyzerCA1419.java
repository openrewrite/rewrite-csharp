...
public class ProvidePublicParameterlessSafeHandleConstructorAnalyzerCA1419 extends RoslynRecipe {
    ...
    final String displayName = "Provide a parameterless constructor that is as visible as the containing type for concrete types derived from 'System.Runtime.InteropServices.SafeHandle' (search)";
    ...
    final Set<String> tags = Stream.of("roslyn", "analyzer", "CA1419", "microsoft", "csharp", "dotnet", "c#").collect(toSet());
