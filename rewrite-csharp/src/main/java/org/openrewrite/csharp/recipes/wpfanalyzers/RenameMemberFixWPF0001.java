...
public class RenameMemberFixWPF0001 extends RoslynRecipe {
    ...
    public String getDisplayName() {
        return "Backing field for a DependencyProperty should match registered name";
    }
    ...
    public Set<String> getTags() {
        return Stream.of("roslyn", "codefix", "WPF0001", "wpfanalyzers", "csharp", "dotnet", "c#").collect(Collectors.toSet());
    }
    }
