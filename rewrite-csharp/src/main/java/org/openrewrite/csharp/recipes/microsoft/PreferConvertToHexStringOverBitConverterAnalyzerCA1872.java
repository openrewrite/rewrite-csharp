...
public class PreferConvertToHexStringOverBitConverterAnalyzerCA1872 extends RoslynRecipe {
    ...
    public String getDisplayName() {
        return "Analysis: Prefer 'Convert.ToHexString' and 'Convert.ToHexStringLower' over call chains based on 'BitConverter.ToString'";
    }
    ...
    public Set<String> getTags() {
        return Stream.of("roslyn", "analyzer", "CA1872", "microsoft", "csharp", "dotnet", "c#").collect(Collectors.toSet());
    }
    }
