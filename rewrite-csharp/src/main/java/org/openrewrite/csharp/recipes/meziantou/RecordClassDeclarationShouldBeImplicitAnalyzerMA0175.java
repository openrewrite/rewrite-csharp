...
public class RecordClassDeclarationShouldBeImplicitAnalyzerMA0175 extends RoslynRecipe {
    ...
    public String getDisplayName() {
        return "Analysis: Record should not use explicit 'class' keyword";
    }
    ...
    public Set<String> getTags() {
        return Stream.of("roslyn", "analyzer", "MA0175", "meziantou", "csharp", "dotnet", "c#").collect(Collectors.toSet());
    }
    }
