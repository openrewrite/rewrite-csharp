...
public class DoNotSetSwitchCA5361 extends RoslynRecipe {
    ...
    public String getDisplayName() {
        return "Analysis: Do Not Disable SChannel Use of Strong Crypto";
    }
    ...
    public Set<String> getTags() {
        return Stream.of("roslyn", "analyzer", "CA5361", "microsoft", "csharp", "dotnet", "c#").collect(Collectors.toSet());
    }
    }
