...
public class UseCountProperlyAnalyzerCA1836 extends RoslynRecipe {
    ...
    final String displayName = "Prefer IsEmpty over Count (search)";
    ...
    final Set<String> tags = Stream.of("roslyn", "analyzer", "CA1836", "microsoft", "csharp", "dotnet", "c#").collect(toSet());
