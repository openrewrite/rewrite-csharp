...
public class OverrideEqualsAndOperatorEqualsOnValueTypesAnalyzerCA1815 extends RoslynRecipe {
    ...
    public String getDisplayName() {
        return "Analysis: Override equals and operator equals on value types";
    }
    ...
    public Set<String> getTags() {
        return Stream.of("roslyn", "analyzer", "CA1815", "microsoft", "csharp", "dotnet", "c#").collect(Collectors.toSet());
    }
    }
