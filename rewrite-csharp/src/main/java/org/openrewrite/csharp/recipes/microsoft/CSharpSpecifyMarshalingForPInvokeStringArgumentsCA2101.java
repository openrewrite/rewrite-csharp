...
public class CSharpSpecifyMarshalingForPInvokeStringArgumentsCA2101 extends RoslynRecipe {
    ...
    public Set<String> getTags() {
        return Stream.of("roslyn", "CA2101", "microsoft", "csharp", "dotnet", "c#").collect(toSet());
    }
    }
