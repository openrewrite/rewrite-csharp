...
public class CSharpRemoveUnnecessaryAttributeSuppressionsDiagnosticAnalyzerIDE0077 extends RoslynRecipe {
    ...
    final String displayName = "Avoid legacy format target in 'SuppressMessageAttribute' (search)";
    final String description = "This is a reporting only recipe. ";
    final Set<String> tags = Stream.of("roslyn", "analyzer", "IDE0077", "microsoft", "csharp", "dotnet", "c#").collect(toSet());
