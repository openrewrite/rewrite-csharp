...
public class UnconstrainedTypeParameterCheckedForNullAnalyzerRCS1165 extends RoslynRecipe {
    ...
    public String getDisplayName() {
        return "Analysis: Unconstrained type parameter checked for null";
    }
    ...
    public Set<String> getTags() {
        return Stream.of("roslyn", "analyzer", "RCS1165", "roslynator", "csharp", "dotnet", "c#").collect(Collectors.toSet());
    }
    }
