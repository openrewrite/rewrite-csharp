...
public class CSharpTestForEmptyStringsUsingStringLengthCA1820 extends RoslynRecipe {
    ...
    public Set<String> getTags() {
        return Stream.of("roslyn", "CA1820", "microsoft", "csharp", "dotnet", "c#").collect(toSet());
    }
    }
