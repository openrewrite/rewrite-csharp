...
public class UseAutoValidateAntiforgeryTokenCA5391 extends RoslynRecipe {
    ...
    public String getDisplayName() {
        return "Analysis: Use antiforgery tokens in ASP.NET Core MVC controllers";
    }
    ...
    public Set<String> getTags() {
        return Stream.of("roslyn", "analyzer", "CA5391", "microsoft", "csharp", "dotnet", "c#").collect(Collectors.toSet());
    }
    }
