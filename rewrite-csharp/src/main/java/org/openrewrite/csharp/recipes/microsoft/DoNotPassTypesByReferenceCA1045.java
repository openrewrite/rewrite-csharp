...
public class DoNotPassTypesByReferenceCA1045 extends RoslynRecipe {
    ...
    final String displayName = "Do not pass types by reference (search)";
    ...
    final Set<String> tags = Stream.of("roslyn", "analyzer", "CA1045", "microsoft", "csharp", "dotnet", "c#").collect(toSet());
