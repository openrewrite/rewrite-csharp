...
public class CSharpRemoveUnnecessaryImportsDiagnosticAnalyzerEnableGenerateDocumentationFile extends RoslynRecipe {
    ...
    final String displayName = "Set MSBuild property 'GenerateDocumentationFile' to 'true' (search)";
    ...
    final Set<String> tags = Stream.of("roslyn", "analyzer", "EnableGenerateDocumentationFile", "microsoft", "csharp", "dotnet", "c#").collect(toSet());
