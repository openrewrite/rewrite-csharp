...
public class DoNotUseReferenceEqualsWithValueTypesAnalyzerCA2013 extends RoslynRecipe {
    ...
    final String displayName = "Do not use ReferenceEquals with value types (search)";
    ...
    final Set<String> tags = Stream.of("roslyn", "analyzer", "CA2013", "microsoft", "csharp", "dotnet", "c#").collect(toSet());
