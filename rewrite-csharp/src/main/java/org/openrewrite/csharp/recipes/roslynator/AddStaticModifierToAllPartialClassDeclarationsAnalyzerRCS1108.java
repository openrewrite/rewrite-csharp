...
public class AddStaticModifierToAllPartialClassDeclarationsAnalyzerRCS1108 extends RoslynRecipe {
    ...
    public String getDisplayName() {
        return "Analysis: Add 'static' modifier to all partial class declarations";
    }
    ...
    public Set<String> getTags() {
        return Stream.of("roslyn", "analyzer", "RCS1108", "roslynator", "csharp", "dotnet", "c#").collect(Collectors.toSet());
    }
    }
