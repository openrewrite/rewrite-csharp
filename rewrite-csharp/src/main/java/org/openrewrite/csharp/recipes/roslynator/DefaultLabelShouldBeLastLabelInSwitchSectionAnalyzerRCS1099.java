...
public class DefaultLabelShouldBeLastLabelInSwitchSectionAnalyzerRCS1099 extends RoslynRecipe {
    ...
    public String getDisplayName() {
        return "Analysis: Default label should be the last label in a switch section";
    }
    ...
    public Set<String> getTags() {
        return Stream.of("roslyn", "analyzer", "RCS1099", "roslynator", "csharp", "dotnet", "c#").collect(Collectors.toSet());
    }
    }
