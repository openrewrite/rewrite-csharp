...
public class SA1207ProtectedMustComeBeforeInternalSA1207 extends RoslynRecipe {
    ...
    final String displayName = "Protected should come before internal (search)";
    ...
    final Set<String> tags = Stream.of("roslyn", "analyzer", "SA1207", "stylecop", "csharp", "dotnet", "c#").collect(toSet());
