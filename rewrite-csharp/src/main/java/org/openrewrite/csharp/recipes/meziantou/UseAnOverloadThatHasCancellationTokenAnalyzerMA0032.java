...
public class UseAnOverloadThatHasCancellationTokenAnalyzerMA0032 extends RoslynRecipe {
    ...
    public String getDisplayName() {
        return "Analysis: Use an overload with a CancellationToken argument";
    }
    ...
    public Set<String> getTags() {
        return Stream.of("roslyn", "analyzer", "MA0032", "meziantou", "csharp", "dotnet", "c#").collect(Collectors.toSet());
    }
    }
