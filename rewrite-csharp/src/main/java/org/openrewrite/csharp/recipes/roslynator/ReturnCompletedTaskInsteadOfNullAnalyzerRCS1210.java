...
public class ReturnCompletedTaskInsteadOfNullAnalyzerRCS1210 extends RoslynRecipe {
    ...
    public String getDisplayName() {
        return "Analysis: Return completed task instead of returning null";
    }
    ...
    public Set<String> getTags() {
        return Stream.of("roslyn", "analyzer", "RCS1210", "roslynator", "csharp", "dotnet", "c#").collect(Collectors.toSet());
    }
    }
