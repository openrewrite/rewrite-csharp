...
@Getter
public class CSharpDisableRuntimeMarshallingFixerCA1421 extends RoslynRecipe {
    ...
    final Set<String> tags = Stream.of("roslyn", "codefix", "CA1421", "microsoft", "csharp", "dotnet", "c#").collect(Collectors.toSet());
