...
//
//public class DependencyInsight([Option("Package Pattern", "Package Pattern", "")] string? packagePattern) : Recipe
//{
//    public override string DisplayName => "Dependency Insight";
//
//    public override string Description => "Search for dependency of specific package";
//
