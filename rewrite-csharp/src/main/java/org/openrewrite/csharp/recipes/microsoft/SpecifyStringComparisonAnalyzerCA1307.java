...
public class SpecifyStringComparisonAnalyzerCA1307 extends RoslynRecipe {
    @Getter
    final String recipeId = "CA1307";
    ...
    @Getter
    final String displayName = "Analysis: Specify StringComparison for clarity";
    ...
    @Getter
    final Set<String> tags = Stream.of("roslyn", "analyzer", "CA1307", "microsoft", "csharp", "dotnet", "c#").collect(Collectors.toSet());
