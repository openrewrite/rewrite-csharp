...
@Getter
public class CSharpPreferIsEmptyOverCountFixerCA1836 extends RoslynRecipe {
    ...
    final Set<String> tags = Stream.of("roslyn", "codefix", "CA1836", "microsoft", "csharp", "dotnet", "c#").collect(Collectors.toSet());
