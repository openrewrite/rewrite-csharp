...
public class CSharpPreventNumericIntPtrUIntPtrBehavioralChangesCA2020 extends RoslynRecipe {
    ...
    final String displayName = "Prevent behavioral change (search)";
    ...
    final Set<String> tags = Stream.of("roslyn", "analyzer", "CA2020", "microsoft", "csharp", "dotnet", "c#").collect(toSet());
