...
;");
        ...
        yield return            new SourceTestCase("ExpressionParsingTests.TestAltInterpolatedVerbatimString_CSharp8",@"@$""hello""");

        yield return            new SourceTestCase("ExpressionParsingTests.TestNestedAltInterpolatedVerbatimString_CSharp73","$@\"aaa{@$\"bbb\nccc\"}ddd\"");

        yield return            new SourceTestCase("ExpressionParsingTests.TestNestedAltInterpolatedVerbatimString_CSharp8","$@\"aaa{@$\"bbb\nccc\"}ddd\"");

        yield return            new SourceTestCase("ExpressionParsingTests.TestInterpolatedStringWithNewLinesInExpression",@"$""Text with {
    new[] {
        1, 2, 3
    }[2]
} parts and new line expressions!""");

        yield return            new SourceTestCase("ExpressionParsingTests.TestName","goo");
...
class c
{
    ...
    void m2()
    {
        ...
        yield return            new SourceTestCase("LocalFunctionParsingTests.StaticFunctions",@"class Program
{
    void M()
    {
        static void F() { }
        ...
        yield return            new SourceTestCase("LocalFunctionParsingTests.AsyncStaticFunctions",@"class Program
{
    void M()
    {
        ...
        yield return            new SourceTestCase("ParserErrorMessageTests.CS1031ERR_TypeExpected02_Tuple",@"namespace x
{
    public class @a
    {
...
");
        ...
        yield return            new SourceTestCase("ParserErrorMessageTests.CS1031ERR_TypeExpected02WithCSharp6_Tuple",@"namespace x
{
    public class @a
    {
        public static void Main()
...
");
        ...
        yield return            new SourceTestCase("ParserErrorMessageTests.CS1031ERR_TypeExpected02WithCSharp7_Tuple",@"namespace x
{
    public class @a
    {
        public static void Main()
...
");
        ...
        yield return            new SourceTestCase("UsingDirectiveParsingTests.AliasUsingDirectiveNamePointer1",@"using x = A*;

struct A { }");

        yield return            new SourceTestCase("UsingDirectiveParsingTests.AliasUsingDirectiveNamePointer2",@"using unsafe x = A*;
...
namespace N
{
    using unsafe Y = X[];
        ...
        yield return            new SourceTestCase("UsingDirectiveParsingTests.AliasUsingVoidPointer1",@"using unsafe VP = void*;
...
class C
{
    void M(VP vp) { }
        ...
        yield return            new SourceTestCase("UsingDirectiveParsingTests.AliasUsingVoidPointer2",@"using unsafe VP = void*;
...
class C
{
    unsafe void M(VP vp) { }
        ...
        yield return            new SourceTestCase("UsingDirectiveParsingTests.AliasUsingVoidPointer3",@"using VP = void*;
