...
public class CastFixWPF0022 extends RoslynRecipe {
    @Getter
    ...
    @Getter
    final Set<String> tags = Stream.of("roslyn", "codefix", "WPF0022", "wpfanalyzers", "csharp", "dotnet", "c#").collect(Collectors.toSet());
