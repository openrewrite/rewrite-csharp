...
public class DynamicInterfaceCastableImplementationAnalyzerCA2256 extends RoslynRecipe {
    @Getter
    ...
    @Getter
    final String displayName = "Analysis: All members declared in parent interfaces must have an implementation in a DynamicInterfaceCastableImplementation-attributed interface";
    ...
    @Getter
    final Set<String> tags = Stream.of("roslyn", "analyzer", "CA2256", "microsoft", "csharp", "dotnet", "c#").collect(Collectors.toSet());
