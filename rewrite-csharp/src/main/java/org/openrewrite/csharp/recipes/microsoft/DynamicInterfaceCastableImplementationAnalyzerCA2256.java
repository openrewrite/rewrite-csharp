...
public class DynamicInterfaceCastableImplementationAnalyzerCA2256 extends RoslynRecipe {
    ...
    public String getDisplayName() {
        return "Analysis: All members declared in parent interfaces must have an implementation in a DynamicInterfaceCastableImplementation-attributed interface";
    }
    ...
    public Set<String> getTags() {
        return Stream.of("roslyn", "analyzer", "CA2256", "microsoft", "csharp", "dotnet", "c#").collect(Collectors.toSet());
    }
    }
