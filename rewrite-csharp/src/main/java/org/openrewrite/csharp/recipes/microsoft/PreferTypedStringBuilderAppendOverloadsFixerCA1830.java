...
@Getter
public class PreferTypedStringBuilderAppendOverloadsFixerCA1830 extends RoslynRecipe {
    ...
    final Set<String> tags = Stream.of("roslyn", "codefix", "CA1830", "microsoft", "csharp", "dotnet", "c#").collect(Collectors.toSet());
