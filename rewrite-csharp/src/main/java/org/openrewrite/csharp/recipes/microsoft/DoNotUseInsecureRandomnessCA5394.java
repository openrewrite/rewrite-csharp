...
public class DoNotUseInsecureRandomnessCA5394 extends RoslynRecipe {
    ...
    final String displayName = "Do not use insecure randomness (search)";
    ...
    final Set<String> tags = Stream.of("roslyn", "analyzer", "CA5394", "microsoft", "csharp", "dotnet", "c#").collect(toSet());
