...
public class GenericTypeParameterDocumentationAnalyzerSA1620 extends RoslynRecipe {
    ...
    final String displayName = "Generic type parameter documentation should match type parameters (search)";
    ...
    final Set<String> tags = Stream.of("roslyn", "analyzer", "SA1620", "stylecop", "csharp", "dotnet", "c#").collect(toSet());
