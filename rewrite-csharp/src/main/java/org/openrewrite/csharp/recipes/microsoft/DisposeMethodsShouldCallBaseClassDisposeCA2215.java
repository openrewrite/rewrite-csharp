...
public class DisposeMethodsShouldCallBaseClassDisposeCA2215 extends RoslynRecipe {
    ...
    public String getDisplayName() {
        return "Analysis: Dispose methods should call base class dispose";
    }
    ...
    public Set<String> getTags() {
        return Stream.of("roslyn", "analyzer", "CA2215", "microsoft", "csharp", "dotnet", "c#").collect(Collectors.toSet());
    }
    }
