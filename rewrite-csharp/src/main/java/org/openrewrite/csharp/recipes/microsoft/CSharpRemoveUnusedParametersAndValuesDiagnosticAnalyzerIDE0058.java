...
public class CSharpRemoveUnusedParametersAndValuesDiagnosticAnalyzerIDE0058 extends RoslynRecipe {
    ...
    final String displayName = "Expression value is never used (search)";
    final String description = "This is a reporting only recipe. ";
    final Set<String> tags = Stream.of("roslyn", "analyzer", "IDE0058", "microsoft", "csharp", "dotnet", "c#").collect(toSet());
