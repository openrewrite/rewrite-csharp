...
public class LocalVariablesShouldNotHideSymbolsAnalyzerMA0084 extends RoslynRecipe {
    ...
    public String getDisplayName() {
        return "Analysis: Local variables should not hide other symbols";
    }
    ...
    public Set<String> getTags() {
        return Stream.of("roslyn", "analyzer", "MA0084", "meziantou", "csharp", "dotnet", "c#").collect(Collectors.toSet());
    }
    }
