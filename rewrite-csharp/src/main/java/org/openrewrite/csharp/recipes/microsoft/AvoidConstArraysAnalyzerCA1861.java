...
public class AvoidConstArraysAnalyzerCA1861 extends RoslynRecipe {
    ...
    @Getter
    final String displayName = "Analysis: Avoid constant arrays as arguments";
    ...
    @Getter
    final Set<String> tags = Stream.of("roslyn", "analyzer", "CA1861", "microsoft", "csharp", "dotnet", "c#").collect(Collectors.toSet());
