...
public class DoNotUseDefaultEqualsOnValueTypeAnalyzerMA0066 extends RoslynRecipe {
    ...
    public String getDisplayName() {
        return "Analysis: Hash table unfriendly type is used in a hash table";
    }
    ...
    public Set<String> getTags() {
        return Stream.of("roslyn", "analyzer", "MA0066", "meziantou", "csharp", "dotnet", "c#").collect(Collectors.toSet());
    }
    }
