...
public class UseAnOverloadThatHasTimeProviderFixerMA0166 extends RoslynRecipe {
    @Getter
    ...
    @Getter
    final Set<String> tags = Stream.of("roslyn", "codefix", "MA0166", "meziantou", "csharp", "dotnet", "c#").collect(Collectors.toSet());
