...
public class AvoidLengthCalculationWhenSlicingToEndFixerCA1514 extends RoslynRecipe {
    @Getter
    ...
    @Getter
    final Set<String> tags = Stream.of("roslyn", "codefix", "CA1514", "microsoft", "csharp", "dotnet", "c#").collect(Collectors.toSet());
