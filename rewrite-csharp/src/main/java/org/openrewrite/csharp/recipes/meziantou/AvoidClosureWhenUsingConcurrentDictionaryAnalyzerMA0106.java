...
public class AvoidClosureWhenUsingConcurrentDictionaryAnalyzerMA0106 extends RoslynRecipe {
    ...
    public String getDisplayName() {
        return "Analysis: Avoid closure by using an overload with the 'factoryArgument' parameter";
    }
    ...
    public Set<String> getTags() {
        return Stream.of("roslyn", "analyzer", "MA0106", "meziantou", "csharp", "dotnet", "c#").collect(Collectors.toSet());
    }
    }
