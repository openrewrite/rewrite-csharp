...
public class StringShouldNotContainsNonDeterministicEndOfLineAnalyzerMA0101 extends RoslynRecipe {
    ...
    public String getDisplayName() {
        return "Analysis: String contains an implicit end of line character";
    }
    ...
    public Set<String> getTags() {
        return Stream.of("roslyn", "analyzer", "MA0101", "meziantou", "csharp", "dotnet", "c#").collect(Collectors.toSet());
    }
    }
