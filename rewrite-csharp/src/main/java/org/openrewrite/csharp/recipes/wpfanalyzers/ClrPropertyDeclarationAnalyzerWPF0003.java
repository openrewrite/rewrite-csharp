...
public class ClrPropertyDeclarationAnalyzerWPF0003 extends RoslynRecipe {
    ...
    final String displayName = "CLR property for a DependencyProperty should match registered name (search)";
    ...
    final Set<String> tags = Stream.of("roslyn", "analyzer", "WPF0003", "wpfanalyzers", "csharp", "dotnet", "c#").collect(toSet());
