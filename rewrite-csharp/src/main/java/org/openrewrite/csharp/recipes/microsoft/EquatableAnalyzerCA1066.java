...
public class EquatableAnalyzerCA1066 extends RoslynRecipe {
    ...
    public String getDisplayName() {
        return "Analysis: Implement IEquatable when overriding Object.Equals";
    }
    ...
    public Set<String> getTags() {
        return Stream.of("roslyn", "analyzer", "CA1066", "microsoft", "csharp", "dotnet", "c#").collect(Collectors.toSet());
    }
    }
