...
{
    public static SourceFileHeader FromFile(AbsolutePath licenseFile, AbsolutePath autogeneratedFile)
    {
        string ReadFile(AbsolutePath file)
        {
        ...
        return new SourceFileHeader(ReadFile(licenseFile), ReadFile(autogeneratedFile));
    }
