...
public class UsePatternMatchingForEqualityComparisonsAnalyzerMA0148 extends RoslynRecipe {
    ...
    public String getDisplayName() {
        return "Analysis: Use pattern matching instead of equality operators for discrete value";
    }
    ...
    public Set<String> getTags() {
        return Stream.of("roslyn", "analyzer", "MA0148", "meziantou", "csharp", "dotnet", "c#").collect(Collectors.toSet());
    }
    }
