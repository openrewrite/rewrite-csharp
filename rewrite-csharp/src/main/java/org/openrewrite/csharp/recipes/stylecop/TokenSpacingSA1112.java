...
public class TokenSpacingSA1112 extends RoslynRecipe {
    ...
    @Getter
    final String displayName = "Closing parenthesis should be on line of opening parenthesis";
    ...
    public Set<String> getTags() {
        return Stream.of("roslyn", "SA1112", "stylecop", "csharp", "dotnet", "c#").collect(toSet());
    }
    }
