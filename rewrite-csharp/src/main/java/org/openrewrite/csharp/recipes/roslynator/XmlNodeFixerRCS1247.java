...
public class XmlNodeFixerRCS1247 extends RoslynRecipe {
    @Getter
    ...
    @Getter
    final Set<String> tags = Stream.of("roslyn", "codefix", "RCS1247", "roslynator", "csharp", "dotnet", "c#").collect(Collectors.toSet());
