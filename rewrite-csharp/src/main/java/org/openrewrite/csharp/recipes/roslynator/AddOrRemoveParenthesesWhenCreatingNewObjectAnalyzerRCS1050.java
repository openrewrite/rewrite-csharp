...
public class AddOrRemoveParenthesesWhenCreatingNewObjectAnalyzerRCS1050 extends RoslynRecipe {
    ...
    final String displayName = "Include/omit parentheses when creating new object (search)";
    final String description = "This is a reporting only recipe. ";
    final Set<String> tags = Stream.of("roslyn", "analyzer", "RCS1050", "roslynator", "csharp", "dotnet", "c#").collect(toSet());
