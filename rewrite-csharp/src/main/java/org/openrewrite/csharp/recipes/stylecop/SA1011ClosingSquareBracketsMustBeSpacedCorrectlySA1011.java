...
public class SA1011ClosingSquareBracketsMustBeSpacedCorrectlySA1011 extends RoslynRecipe {
    ...
    @Getter
    final String displayName = "Analysis: Closing square brackets should be spaced correctly";
    ...
    @Getter
    final Set<String> tags = Stream.of("roslyn", "analyzer", "SA1011", "stylecop", "csharp", "dotnet", "c#").collect(Collectors.toSet());
