...
public class RequiredConfigOptionNotSetAnalyzerROS0003 extends RoslynRecipe {
    ...
    public String getDisplayName() {
        return "Analysis: Analyzer requires config option to be specified";
    }
    ...
    public Set<String> getTags() {
        return Stream.of("roslyn", "analyzer", "ROS0003", "roslynator", "csharp", "dotnet", "c#").collect(Collectors.toSet());
    }
    }
