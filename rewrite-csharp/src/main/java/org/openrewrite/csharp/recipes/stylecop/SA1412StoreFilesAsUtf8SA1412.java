...
public class SA1412StoreFilesAsUtf8SA1412 extends RoslynRecipe {
    ...
    final String displayName = "Store files as UTF-8 with byte order mark (search)";
    ...
    final Set<String> tags = Stream.of("roslyn", "analyzer", "SA1412", "stylecop", "csharp", "dotnet", "c#").collect(toSet());
