...
@Getter
public class CSharpDynamicInterfaceCastableImplementationFixerCA2257 extends RoslynRecipe {
    ...
    final Set<String> tags = Stream.of("roslyn", "codefix", "CA2257", "microsoft", "csharp", "dotnet", "c#").collect(Collectors.toSet());
